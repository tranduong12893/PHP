        ...
        <div class="container">
            ...
            <div class="ht-right">
                ...
                <div class="lan-selector">
                    <section class="language-drop" name="countries" id="countries" style="width: 300px;">
                        <option value='yu' data-image="front/img/flag-2.jpg" data-imagecss="flag yu"
                                adta-little="English">English</option>
                        <option value='yt' data-image="front/img/flag-1.jpg" data-imagecss="flag yt"
                                adta-little="Bangladesh">German</option>
                    </section>
                </div>
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="advanced-search">
                        ...
                        <div class="input-group">
                            <input type="text" placeholder="what do you needs?">
            ...
            <div class="nav-depart">
                <div class="depart-btn">
                    ...
                    <ul class="depart-hover">
                        ...
                        <li><a href="#">brand outdor Apparel</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>167 Tran Dang Ninh . Dich Vong</li>
                        <li>Phone: +84 88.99.69.533</li>
                        <li>Email: giahuy128@gmail.com</li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-text">
                        copyright <script>document.write(new date());</script>
